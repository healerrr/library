...
async def create_crawl_job(
    ...
    if created:
        asyncio.create_task(run_crawl_job(job.id, site_id, settings))
    return job
...
async def create_preview_job(
    ...
    if created:
        asyncio.create_task(run_preview_job(job.id, site_id, settings))
    return job
...
async def create_audit_job(
    ...
    if created:
        asyncio.create_task(run_audit_job(job.id, site_id, settings))
    return job
...
async def create_reindex_job(
    ...
    if created:
        asyncio.create_task(run_reindex_job(job.id, site_id))
    return job
